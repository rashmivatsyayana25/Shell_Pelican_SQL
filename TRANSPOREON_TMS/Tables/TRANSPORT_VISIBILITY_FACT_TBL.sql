CREATE TABLE [TRANSPOREON_TMS].[TRANSPORT_VISIBILITY_FACT_TBL] (
    ...
    CONSTRAINT [PK_TRANSPORT_VISIBILITY_FACT_TBL] PRIMARY KEY CLUSTERED ([DELIVERY_NO] ASC, [TRANSPORT_NO] ASC, [TRANSP_VISIBILITY_STATUS_DESC] ASC)
);
