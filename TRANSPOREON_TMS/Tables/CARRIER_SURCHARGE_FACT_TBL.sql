CREATE TABLE [TRANSPOREON_TMS].[CARRIER_SURCHARGE_FACT_TBL] (
    ...
    CONSTRAINT [PK_CARRIER_SURCHARGE_FACT_TBL] PRIMARY KEY CLUSTERED ([DELIVERY_NO] ASC, [SURCHARGE_ID] ASC)
);
